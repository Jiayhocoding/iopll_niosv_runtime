...
#    * The helper routines are defined in target_iopll_altera_iopll_2110_qllopbq_pin_map.tcl
#
# NOTE
# ----
...
source "$script_dir/target_iopll_altera_iopll_2110_qllopbq_parameters.tcl"
source "$script_dir/target_iopll_altera_iopll_2110_qllopbq_pin_map.tcl"
source "$script_dir/target_iopll_altera_iopll_2110_qllopbq_all_ip_params.tcl"
...
if {[info exists ::GLOBAL_top_target_iopll_altera_iopll_2110_qllopbq_corename_ai_pll_db]} {
    # Clean-up stale content
    unset ::GLOBAL_top_target_iopll_altera_iopll_2110_qllopbq_corename_ai_pll_db
}
if {[catch {ai_initialize_pll_db ::GLOBAL_top_target_iopll_altera_iopll_2110_qllopbq_corename_ai_pll_db} err_initializing_db]} {
...
# following loop
set instances [ array names ::GLOBAL_top_target_iopll_altera_iopll_2110_qllopbq_corename_ai_pll_db ]
foreach { inst } $instances {
    ...
    lassign $::GLOBAL_top_target_iopll_altera_iopll_2110_qllopbq_corename_ai_pll_db($inst) base_clock_data_dict gen_clock_data_dict

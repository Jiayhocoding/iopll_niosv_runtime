...
alias com {
  ...
  set common_design_files [dict values [reset_release::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [reset_release::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]

...
# ACDS 25.1.1 125 win32 2025.08.16.00:32:48
# ----------------------------------------
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [reset_release::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
...
set libraries [dict merge $libraries [reset_release::get_dpi_libraries "$QSYS_SIMDIR"]]
...
alias com {
  ...
  set design_files [concat $design_files [reset_release::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
